...
class ROLO_TF:
    ...
    rolo_weights_file = 'panchen/output/ROLO_model_4/model_step6_exp1.ckpt'
    lstm_depth = 3
    ...
    def train_20(self):
        ...
        self.learning_rate = tf.train.exponential_decay(0.01, global_step, 22*20, 0.1, staticmethod=True)
        # self.learning_rate = 0.00001 #0.00001
        self.optimizer = tf.train.AdamOptimizer(learning_rate=self.learning_rate).minimize(self.accuracy,global_step=global_step)  # Adam Optimizer
